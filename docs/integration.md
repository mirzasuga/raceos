...
│    → 9Router: POST /chat/completions (model: openai/gpt-5)           │
...
│    → OpenCode internally calls 9Router for LLM completions           │
...
| 6 | Planner Node | Generate specs | 9Router → 9Router → GPT-5 |
| 7 | Edge | Route to gate | — |
| 8 | Human Gate | Wait + approve | CLI (factory approve) |
| 9 | Edge | Route to agent | — |
| 10 | Engineer Node | Execute code | OpenCode → 9Router → Claude |
| 11 | Edge | Route to review | — |
| 12 | Reviewer Node | Check code | 9Router → 9Router → Claude |
...
│  │                                                          │           │
│  │  POST https://9router.ai/api/v1/chat/completions     │           │
│  │  Headers:                                                │           │
...
│  │                                                          │           │
│  │  LLM → 9Router → OpenCode → LangGraph state          │           │
...
```
Human        CLI       LangGraph   Knowledge   Context    9Router   Planner   HumanGate  Engineer   OpenCode   9Router    LLM       Reviewer   Validator  KnowledgeAg
  │           │           │           │          │          │          │          │          │          │           │          │           │          │          │
  │──task────►│           │           │          │          │          │          │          │          │           │          │           │          │          │
  │           │──invoke──►│           │          │          │          │          │          │          │           │          │           │          │          │
  │           │           │                      │          │          │          │          │          │           │          │           │          │          │
...
```
Human     LangGraph    9Router     OpenCode    9Router     LLM        9Router(fb)  9Router(fb)   LLM(fb)
  │          │            │           │            │           │             │              │             │
  │──task──► │            │           │            │           │             │              │             │
  │          │──route────►│           │            │           │             │              │             │
  │          │◄─Claude4.6─│           │            │           │             │              │             │
...
│                                                                 │
│  .env                                                           │
│    └── NINE_ROUTER_API_KEY ──► gateway/client.py (auth)          │
│                                                                 │
│  config/router.yaml                                             │
...
```bash
# === REQUIRED ===
NINE_ROUTER_API_KEY=sk-or-v1-your-key-here
...
gateway:
  base_url: "https://9router.ai/api/v1"
...
# 2. Full chain (requires NINE_ROUTER_API_KEY)
source .env
PYTHONPATH=src python3 -c "
from factory.router import NineRouter
